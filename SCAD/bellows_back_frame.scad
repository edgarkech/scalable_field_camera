...
vBellowsFrameScrewHole_offsetX = (vLowerCube_l)/2;
vBellowsFrameScrewHole_offsetY = vBellowsFrameScrewHole_offsetXY;
...
difference(){
    ...
    // outer screw holes 
    // screws in x/-x direction    
    translate([vBellowsFrameScrewHole_offsetX, vBellowsFrameScrewHole_offsetY, vBellowsFrameScrewHole_offsetZ])
        rotate([0, -90, 0])
            cylinder(d=vBellowsFrameScrewHole_d, h=vBellowsFrameScrewHole_h);
    translate([vBellowsFrameScrewHole_offsetX, -vBellowsFrameScrewHole_offsetY, vBellowsFrameScrewHole_offsetZ])
        rotate([0, -90, 0])
            cylinder(d=vBellowsFrameScrewHole_d, h=vBellowsFrameScrewHole_h);
    translate([-vBellowsFrameScrewHole_offsetX, vBellowsFrameScrewHole_offsetY, vBellowsFrameScrewHole_offsetZ])
    ...
    // screws in y/-y direction    
    translate([vBellowsFrameScrewHole_offsetY, vBellowsFrameScrewHole_offsetX, vBellowsFrameScrewHole_offsetZ])
        rotate([90, 0, 0])
            cylinder(d=vBellowsFrameScrewHole_d, h=vBellowsFrameScrewHole_h);
    translate([vBellowsFrameScrewHole_offsetY, -vBellowsFrameScrewHole_offsetX, vBellowsFrameScrewHole_offsetZ])
        rotate([-90, 0, 0])
